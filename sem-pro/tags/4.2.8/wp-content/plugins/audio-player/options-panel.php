...
<!--
	<?php if( function_exists( "curl_init" ) || ini_get( "allow_url_fopen" ) ) { ?>	<form style="float:right;margin:0 0 0 10px;" method="post" class="submit"><input type="submit" class="button" name="ap_updateCheck" value="Check for updates" /></form>
	<?php } ?>-->
...
<!--
	<p>Current version: <strong><?php echo $ap_version; ?></strong>
-->
	<?php if( !function_exists( "curl_init" ) && !ini_get( "allow_url_fopen" ) ) { ?> (Visit <a href="<?php echo $ap_docURL; ?>">1 Pixel Out</a> to check for updates)<?php } ?></p>
	<form method="post">
	<fieldset class="options">
		...
		<table class="editform" cellpadding="5" cellspacing="2" width="100%">
			<tr>
				...
				<td>
					<input type="text" id="ap_audiowebpath" name="ap_audiowebpath" size="40" value="<?php echo( get_ap_option("audio_player_web_path") ); ?>" /><br />
	...
	<fieldset class="options">
		...
		<table class="editform" cellpadding="5" cellspacing="2" width="100%">
			<tr>
				...
				<td>
					<input type="text" id="ap_audioprefixwebpath" name="ap_audioprefixwebpath" size="60" value="<?php echo( get_ap_option("audio_player_prefixaudio") ); ?>" /><br />
			...
			<tr>
				...
				<td>
					<input type="text" id="ap_audiopostfixwebpath" name="ap_audiopostfixwebpath" size="60" value="<?php echo( get_ap_option("audio_player_postfixaudio") ); ?>" /><br />
	...
	<fieldset class="options">
		...
		<table class="editform" cellpadding="5" cellspacing="2" width="100%">
			...
			<tr>
				...
				<td>
					<input type="text" id="ap_rsscustomalternate" name="ap_rsscustomalternate" size="60" value="<?php echo( get_ap_option("audio_player_rsscustomalternate") ); ?>" />
				</td>
			</tr>
		</table>
	</fieldset>
	...
	<fieldset class="options">
		...
		<?php echo ap_getplayer(get_ap_option( siteurl ) . "/wp-content/plugins/audio-player/test.mp3", $ap_demo_options); ?>
		<br /><br />

		<img src="<?php echo get_ap_option( siteurl ); ?>/wp-content/plugins/audio-player/map.gif" alt="Colour map" width="390" height="124" />
	</fieldset>

	<a href="<?php echo $ap_docURL; ?>"><img src="<?php echo get_ap_option("siteurl" ); ?>/wp-content/plugins/audio-player/logo.gif" style="float:left;margin:10px 0 0 5px;" /></a>
	<p class="submit">
