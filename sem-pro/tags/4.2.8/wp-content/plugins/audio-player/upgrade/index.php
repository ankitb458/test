...
<?php if( !isset( $_POST["upgrade"] ) ) { ?>	<input type="submit" name="upgrade" value="Upgrade &raquo;" />
	<input type="button" name="close" onclick="self.close()" value="Cancel" />
<?php } else { ?>	<input type="button" name="close" onclick="self.close()" value="Finish" />
<?php } ?></form>
...
$ap_archiveURL = "http://www.1pixelout.net/download/audio-player2.zip";
