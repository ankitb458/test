...
If you are not familiar with php and with programming, be advised that the custom.php feature is probably not for you. In programming commonspeak, the Semiologic theme is a variable length multi-dimentional array of function pointers, i.e. about as abstract and complicated as computer programming can get.

Before we go through the example, two points are worth a mention: how the theme works, and the defaults canvas.
