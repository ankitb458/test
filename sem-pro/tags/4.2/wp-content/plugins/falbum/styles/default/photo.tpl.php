...
<?php if ($can_edit == true): ?>	<div id='falbum-post-helper-switch'><img src="<?php echo get_settings('siteurl'); ?>/wp-content/plugins/falbum/styles/default/images/wrench.png" alt="Post Helper" title="Post Helper" width="16" height="16" /></div>
	<div id='falbum-post-helper-block' style="display: none">
		...
		<table>
		<tr><td valign="top"><?php echo __('Size', FALBUM_DOMAIN); ?>:</td><td>
	    ...
	    <tr><td valign="top"><?php echo __('Position', FALBUM_DOMAIN); ?>:</td><td>
	    <input type="radio" name="position" value="l" checked="checked" id="position-l"> <label for="position-l"><?php echo __('Float left', FALBUM_DOMAIN); ?></label><br />
		<input type="radio" name="position" value="r" id="position-r"> <label for="position-r"><?php echo __('Float right', FALBUM_DOMAIN); ?></label><br />
		<!--<input type="radio" name="position" value="c" id="position-c"> <label for="position-c"><?php echo __('Center', FALBUM_DOMAIN); ?></label><br />-->
		</td></tr>
		<tr><td valign="top"><?php echo __('Link to', FALBUM_DOMAIN); ?>:</td><td>
	    <input type="radio" name="linkto" value="p" checked="checked" id="linkto-photo"> <label for="linkto-photo"><?php echo __('Photo', FALBUM_DOMAIN); ?></label><br />
		<input type="radio" name="linkto" value="i" id="linkto-index"> <label for="linkto-index"><?php echo __('Index page', FALBUM_DOMAIN); ?></label><br />
		</td></tr>
		</table>
		</div>
	<br />
	<?php echo __('Copy and paste the following line into your post', FALBUM_DOMAIN); ?>:
...
<?php if (isset($tags)): ?><div class='falbum-tags-block'>
...
<?php endif; ?>
<?php if (isset($notes)): ?><map id='imgmap'>
	<?php foreach ($notes as $note): ?>		<area alt='' title="<?php echo $note['title']; ?>" nohref='nohref' shape='rect' coords='<?php echo $note['coords']; ?>' />
	<?php endforeach; ?></map>
<?php endif; ?>
<div class='falbum-photo-block'>
	...
	<div class='falbum-nav'>
		<?php if (isset($prev_button)): ?>			<?php echo $prev_button; ?>&nbsp;&nbsp;
		<?php endif; ?> 
		
		<?php echo $return_button; ?>		
		<?php if (isset($next_button)): ?>			&nbsp;&nbsp;<?php echo $next_button; ?>		<?php endif; ?>	</div> 	
</div> 
...
<div class='falbum-meta'>
	...
	<?php if (isset($sizes_label)): ?>	<div class='falbum-photoSizesBlock'>
	...
	<?php if (isset($exif_label)): ?>	<div id='exif' class='falbum-exif'>
		<a href="javascript:showExif('<?php echo $exif_data; ?>')"><?php echo $exif_label; ?></a>
	</div>
	<?php endif; ?>	
	<?php if (isset($comments)): ?>	<div class="falbum-comment-block">
	<span class="falbum-comment-title"><?php echo __('Comments', FALBUM_DOMAIN); ?>:</span>
	<?php foreach ($comments as $comment): ?>		<div class="falbum-comment-author"><a href="<?php echo $comment['author_url']; ?>"><?php echo $comment['author_name']; ?></a></div>
...
//<!--
	falbum_remote_url = '<?php echo $remote_url; ?>';
