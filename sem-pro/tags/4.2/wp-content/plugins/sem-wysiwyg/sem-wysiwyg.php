...
<img src="<?php echo trailingslashit(get_option('siteurl')) ?>wp-content/<?php echo function_exists('get_site_option') ? 'mu-plugins/' : 'plugins/'; ?>sem-wysiwyg/sem-wysiwyg.gif" onload="initFCK();" />
		<?php
	}
