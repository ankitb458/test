...
class page_tags_admin
{
	...
	function init()
	{
		add_action('admin_menu', array('page_tags_admin', 'meta_boxes'));
		
		add_action('admin_print_scripts', array('page_tags_admin', 'register_scripts'));

		add_filter('sem_api_key_protected', array('page_tags_admin', 'sem_api_key_protected'));
	} # init()
	...
	{
		$array[] = 'http://www.semiologic.com/media/software/publishing/page-tags/page-tags.zip';
	...
	function meta_boxes()
	{
		...
		{
			add_meta_box('tagsdiv', 'Tags', array('page_tags_admin', 'display_page_tags'), 'page', 'normal');
