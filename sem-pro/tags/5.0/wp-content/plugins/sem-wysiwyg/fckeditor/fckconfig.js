...
FCKConfig.Plugins.Add( 'GoogleSpellCheck', 'en' ) ;
...
if ( window.parent.document.show_fck_media )
{
...
if ( window.parent.document.show_fck_contactform )
{
	wp_buttons.push('WordPressContactForm');
}

if ( window.parent.document.show_fck_newsletter )
{
	wp_buttons.push('WordPressNewsletter');
}

if ( window.parent.document.show_fck_podcast )
{
	wp_buttons.push('WordPressPodcast');
}

if ( window.parent.document.show_fck_videocast )
{
	wp_buttons.push('WordPressVideocast');
}
...
FCKConfig.FontNames		= 'Arial;Book Antica;Bookman Old Style;Comic Sans MS;Courier New;Garamond;Georgia;Monotype Corsiva;Tahoma;Times New Roman;Trebuchet MS;Verdana' ;
...
FCKConfig.SmileyPath	= FCKConfig.BasePath + 'images/smiley/yahoo/' ;
