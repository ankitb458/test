 ...
 */
	...
	init = function () 
	{
		...
		if (param) 
		{
			...
			if (param["f_url"].indexOf("/") != 0) {
				// don't prepend slash for external images
				if ((param["f_url"].indexOf("http://") == -1) && (param["f_url"].indexOf("https://") == -1))
					param["f_url"] = '/'+param["f_url"];
			}
	...
	function newFolder() 
	{
		...
		Dialog("newfolder.php", function(param) 
		{
