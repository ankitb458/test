...
function <?php echo $fn_enable_name;?>(){
	...
	createHiddenField();
	//addVerbage();
	loadHashCashKey('<?php echo trailingslashit(get_option('siteurl')); ?>wp-content/plugins/wp-hashcash/wp-hashcash-getkey.php', '<?php echo $field_id; ?>');
}
