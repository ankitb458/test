...
<?php if ( !version_compare("4.0", mysql_get_server_info(), '<=') ) : ?>

<div style="padding: 10px 20px; margin: 10px 0px; border: solid 1px black;">
<p><?php _e('WordPress 2.1 requires MySQL 4.0 or later. Your version is ' . mysql_get_server_info() . '.'); ?></p>
<p><?php _e('Contact your host and have them upgrade your MySQL server.'); ?></p>
</div>
