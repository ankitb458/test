...
//			'feedster' => 'addfeedster.gif',
	...
	var $service_subscribe_urls = array(
			...
			'google' => 'http://www.google.com/reader/preview/*/feed/%feed_url%',
...
//			'feedster' => 'http://www.feedster.com/myfeedster.php?action=addrss&amp;rssurl=%feed_url%',
			...
			'pluck' => 'http://client.pluck.com/pluckit/prompt.aspx?GCID=C12286x053&amp;a=%feed_url%',
	...
	function widget_control()
	{
		...
		if ( $_POST["sem_subscribe_me_widget_update"] )
		{
			...
			$new_options['title'] = strip_tags(stripslashes($_POST["sem_subscribe_me_widget_title"]));
