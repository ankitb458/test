...
function sem_external_links_admin()
{
	...
	echo '<p><label for="sem_external_links[global]">'
		. '<input type="checkbox"'
			...
			. ' />'
		. '&nbsp;'
		. __('Identify external links outside of the posts.')
		. '</label>'
		. '</p>';
	...
	echo '<p><label for="sem_external_links[add_css]">'
		. '<input type="checkbox"'
			...
			. ' />'
		. '&nbsp;'
		. __('Add an external link icon. You can use a class="noicon" attribute on links to override this.')
		. '</label>'
		. '</p>';
	...
	echo '<p><label for="sem_external_links[add_target]">'
		. '<input type="checkbox"'
			...
			. ' />'
		. '&nbsp;'
		. __('Open external links in a new window. Note that it is poor usability practice.')
		. '</label>'
		. '</p>';
