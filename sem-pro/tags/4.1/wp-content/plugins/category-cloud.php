...
Description: Adds a sidebar widget to display the categories as a tag cloud. Based on <a href="Matt">http://www.hitormiss.org/projects/weighted-categories/">Matt Kingston's Weighted Categories</a> WP plugin.
Author: Lee Kelleher
Version: 1.0
...
function widget_catcloud_init() {
        ...
        function widget_catcloud_control() {
                ...
                if ( $_POST['catcloud-submit'] ) {
                        ...
                        //$newoptions['exclude'] = explode(',', trim(strip_tags(stripslashes($_POST['catcloud-exclude']))));
        ...
        ?>
                        <div style="text-align:right">
                                ...
                                <label for="catcloud-exclude" style="line-height:35px;display:block;">categories to exclude (separated by commas): <textarea id="catcloud-exclude" name="catcloud-exclude" style="width:290px;height:20px;"><?php echo $options['exclude']; ?></textarea></label>
        ...
        function widget_catcloud($args) {
                ...
                $cats = wp_list_cats("list=0&sort_column=name&optioncount=1&use_desc_for_title=0$exclude&recurse=1&hierarchical=0");
