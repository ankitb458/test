...
function theme_feature_is_active($feature_id)
{
	...
	case 'cron_gravatar':
		return plugin_is_active('gravatars2-wpcron.php');
	...
	case 'feedburner':
		return plugin_is_active('ol_feedburner.php');
	...
	case 'enhance_comment_admin':
		return plugin_is_active('edit-comments-full.php')
			|| plugin_is_active('commentcontrol.php');
	...
	case 'theme_credits':
		return !isset($GLOBALS['semiologic']['theme_credits'])
				|| $GLOBALS['semiologic']['theme_credits'];
...
function theme_feature_activate($feature_id)
{
	...
	case 'automatic_translation':
		plugin_activate('translator.php');
		break;
	...
	case 'feedburner':
		plugin_activate('ol_feedburner.php');
		break;
	...
	case 'enhance_comment_admin':
		plugin_activate('edit-comments-full.php');
...
function theme_feature_deactivate($feature_id)
{
	...
	case 'feedburner':
		plugin_deactivate('ol_feedburner.php');
		break;
	...
	case 'enhance_comment_admin':
		plugin_deactivate('edit-comments-full.php');
	...
	case 'theme_credits':
		$GLOBALS['semiologic']['theme_credits'] = false;
		update_option('semiologic', $GLOBALS['semiologic']);
		break;
