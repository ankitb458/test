...
function widget_wpaypal_init() {
	...
	function widget_wpaypal_control() {
		...
		if ( $_POST['wpaypal-submit'] ) {
			...
			$options['pp_email'] = strip_tags(stripslashes($_POST['wpaypal-pp_email']));
			$options['pp_amount'] = strip_tags(stripslashes($_POST['wpaypal-pp_amount']));
			$options['pp_currency'] = strip_tags(stripslashes($_POST['wpaypal-pp_currency']));
