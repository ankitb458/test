...
<div class='falbum-photo-block'>
	...
	<div class='falbum-photo'>
		<a href='<?php echo $photo_url; ?>' title="<?php echo $photo_title_label; ?>">
...
<?php if ($can_edit == true): ?>	
	...
	Event.observe(window, 'load', falbum_photo_init, false);

	function falbum_photo_init(){
