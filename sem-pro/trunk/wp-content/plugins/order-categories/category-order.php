...
function wpguy_category_order_menu(){
	add_posts_page('Category Order', 'Category Order', 'manage_categories', "wpguy_category_order_options", 'wpguy_category_order_options');
}
...
function wpguy_category_order_options(){
	if(isset($_GET['childrenOf'])){
		$childrenOf = intval($_GET['childrenOf']);
	}else{
		$childrenOf = 0;
	}
