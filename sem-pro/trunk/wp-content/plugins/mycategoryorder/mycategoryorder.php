...
{   
	if (function_exists('add_submenu_page'))
		add_submenu_page(mycategoryorder_getTarget(), __('My Category Order','mycategoryorder'), __('My Category Order','mycategoryorder'), 'manage_categories',"mycategoryorder",'mycategoryorder');
}
