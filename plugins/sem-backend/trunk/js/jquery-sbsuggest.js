 ...
 *  renamed to sbsuggest to avoid conflicts with the same script in WP
 */

(function($) {
	$.sbsuggest = function(input, options) {
		var t = this;
		t.input = input;
		t.options = options;
...
$.extend($.sbsuggest.prototype, {
	...
	$.fn.sbsuggest = function(source, options) {
		if (!source) return;
