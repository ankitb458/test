...
CREATE TABLE order_lines (
	...
	init_amount		numeric(6,2) NOT NULL,
	init_comm		numeric(6,2) NOT NULL,
	init_discount	numeric(6,2) NOT NULL,
	rec_amount		numeric(6,2) NOT NULL,
	rec_comm		numeric(6,2) NOT NULL,
	rec_discount	numeric(6,2) NOT NULL,
